...
data_root = 'data/ucf101/rawframes_concat'
data_root_val = 'data/ucf101/rawframes_concat'
split = 1  # official train/test splits. valid numbers: 1, 2, 3
ann_file_train = f'data/ucf101/ucf101_train_split_{split}_rgb+flow_rawframes.txt'
ann_file_val = f'data/ucf101/ucf101_val_split_{split}_rgb+flow_rawframes.txt'
ann_file_test = f'data/ucf101/ucf101_val_split_{split}_rgb+flow_rawframes.txt'

file_client_args = dict(io_backend='disk')
train_pipeline = [
    #dict(type='DecordInit', **file_client_args),
    dict(type='SampleFrames', clip_len=180, frame_interval=2, num_clips=1),
...
optim_wrapper = dict(
    ...
    optimizer=dict(
        type='AdamW', lr=1e-3, betas=(0.9, 0.999), weight_decay=0.03),
